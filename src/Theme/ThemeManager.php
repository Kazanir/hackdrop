...
class AsyncThemeManager extends ThemeManager {
  public function asyncRender(string $hook, array<mixed> $variables) {
  ...
  if (isset($info['function'])) {
    ...
    $output = ($render_function == 'hackutils_async_twig_render_template') ? await $render_function($template_file, $variables) : $render_function($template_file, $variables);
  }
